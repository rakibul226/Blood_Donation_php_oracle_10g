<?php
  ...
  if(!(isset($_SESSION["user_type"]) && $_SESSION["user_type"] == "executive"|| $_SESSION["user_type"] == "patient" || $_SESSION["user_type"] == "bloodbank")) {
      ...
      <?php foreach ($donors as $donor): ?>
        <tr>
          ...
          <!-- <td> -->
            ...
            <!-- <a href="delete-patient.php?id=<?php echo $donor["id"]; ?>">Delete</a> -->
          </td>
        </tr>
      <?php endforeach; ?>
    </tbody>
